import cv2
from app import config # Corrected
from app.utils.logger_setup import log_debug # Corrected

log_debug("processing.frame_processor module initialized.") # Added log
