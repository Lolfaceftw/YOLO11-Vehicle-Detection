...
def run_fast_video_processing_in_thread(file_path, stop_processing_logic_func):
    ...
    def fast_process_task():
        try:
            ...
            if ui_comps.get("fast_progress_label"): # Reset label
                 root.after(0, lambda: ui_comps["fast_progress_label"].config(text="Progress: 0% | --:--:-- Time Left"))
            ...
            app_globals.fast_video_processing_thread = threading.Thread(
                ...
                kwargs={
                    ...
                    # Corrected lambda to accept two arguments
